class QuestionAnswersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @question_answer.save
        format.html { redirect_to question_path(@question_answer.question_id), notice: 'Question answer was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @question_answer.update(question_answer_params)
        format.html { redirect_to question_path(@question_answer.question_id), notice: 'Question answer was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to question_path(question_id), notice: 'Question answer was successfully destroyed.' }
  ...
  private
    ...
    def question_answer_params
      params.require(:question_answer).permit(:choice_id, :explanation, :question_id)
    end
end
